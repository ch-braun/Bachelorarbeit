...
def parse_args():
    ...
    parser.add_argument('--no-save', help='Skip given steps (1 - 6)', action='store_true')
    parser.add_argument('--clear-flattened', help='Skip given steps (1 - 6)', action='store_true')
